...
do
{
printf("\n 1.Insert at Front(First) \t 2.Insert at End(Rear/Last)\t3.Go Back");
printf("\nEnter your choice: ");
scanf("%d", &ch);
switch(ch)
{
...
int ch;
do {
printf("\n1.Delete from Front(First)\t2. Delete from End(Rear/Last))\t3.Go Back");
printf("\nEnter your choice: ");
scanf("%d", &ch);
switch(ch)
{
...
{
case 1: do{
printf("\n1.Insert at Rear\t2.Delete from From Front\t3.Go Back");
printf("\nEnter your choice: ");
scanf("%d", &ch1);
switch(ch1)
{
...
switch(ch)
{
case 1: head=display(head); //Call to Display...
break;
case 2: head=insert(head); //Call to Insert...
break;
case 3: head=del(head);
//Call to delete
break;
case 4: head=queue(head);
break;
case 5: exit(0);
//Exit...
break;
